	...
	<div class="whiteBg">
		...
		<div class="tblDiv-1">
			...
			<div class="formContent" style="padding-bottom: 0px">
				...
				<form:form commandName="poDo" action="addPurchaseOrder.html"
					...
					<table class="formFields" width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td width="35%"><h4>
								...
								<input size="8" readOnly name="poPrefix" id="poPrefix"
								value='PO/RP/<fmt:formatDate pattern="yyyy" value="${currentDate}" />/' />
							...
							<td><h4>
								...
								</h4> <input type="text" size="18" readOnly name="poDateString"
								id="poDateString" value="${poDo.poDateString}">
								<div class="errormsg marR-60">
									<form:errors path="poDate" />
								</div></td>
							<td width="35%"><h4>
